...
const routes: Routes = [
  { path: 'products', component: ProductList, canActivate: [AuthGuard], data: { roles: ['ADMIN', 'USER'] } },
  ...
  { path: 'customers', component: ListCustomers, canActivate: [AuthGuard], data: { roles: ['ADMIN','USER'] } },
  ...
  { path: 'bills', component: ListBills, canActivate: [AuthGuard], data: { roles: ['ADMIN', 'USER'] } },
